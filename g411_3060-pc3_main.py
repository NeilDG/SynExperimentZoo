...
def train_sr_main():
    os.system("python \"train_sr_main.py\" --server_config=6 --img_to_load=-1 "
              "--plot_enabled=0 --save_per_iter=250 --network_version=\"mobisr_v01.03_div2k\" --iteration=1")

    os.system("python \"train_sr_main.py\" --server_config=6 --img_to_load=-1 "
              "--plot_enabled=0 --save_per_iter=250 --network_version=\"mobisr_v01.03_div2k\" --iteration=2")
def test_sr_main():
