...
def train_sr_main():
    os.system("python \"train_sr_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.06_hypersim.8.1\"")

    os.system("python \"train_sr_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.06_hypersim.8.2\"")

    os.system("python \"train_sr_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.06_hypersim.8.3\"")

    os.system("python \"train_sr_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.06_hypersim.8.4\"")

    os.system("python \"train_sr_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.06_hypersim.8.5\"")
...
def train_seg_main():
    ...
    os.system("python \"train_seg_main_2.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=500 --network_version=\"synseg_v00.00_fcg.01.1\"")

def train_img2img_main():
    os.system("python \"train_img2img_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=500 --network_version=\"fcg2cityscapes_v00.00.01.1\"")

def test_img2img_main():
    os.system("python \"test_img2img_main.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=500 --network_version=\"fcg2cityscapes_v00.00.01.1\"")
