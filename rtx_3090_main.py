...
def test_sr_main():
    ...
    #           "--plot_enabled=0 --network_version=\"mobisr_v01.00_div2k\" --iteration=6")
    #
    # os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
    #           "--plot_enabled=0 --network_version=\"mobisr_v01.00_div2k\" --iteration=7")

    os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=0 --network_version=\"mobisr_v01.03_div2k\" --iteration=1")

    os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=0 --network_version=\"mobisr_v01.03_div2k\" --iteration=2")
