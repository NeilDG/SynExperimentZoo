...
def train_sr_main():
    # Model 4 (FFANet) was v02.06, now it's v02.04
    os.system("python \"train_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=250 --network_version=\"mobisr_v02.04_div2k.12.3\"")

def test_sr_main():
    # Model 1 (CycleGAN) was v02.05, now it's v02.01
    os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=0 --network_version=\"mobisr_v02.01_hypersim.10.1\"")

    os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=0 --network_version=\"mobisr_v02.01_hypersim.10.2\"")

    os.system("python \"test_sr_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=0 --network_version=\"mobisr_v02.01_hypersim.10.3\"")

def train_seg_main():
    # Model 1 was v00.00, now it's v00.01
    os.system("python \"train_seg_main_2.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=500 --network_version=\"synseg_v00.01_fcg.1.1\"")

def train_img2img_main():
    # Model 1 was v00.00, now it's v00.01
    os.system("python \"train_img2img_main.py\" --server_config=3 --img_to_load=-1 "
              "--plot_enabled=1 --save_per_iter=500 --network_version=\"fcg2cityscapes_v00.01.1.1\"")
