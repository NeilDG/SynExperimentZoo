...
parser.add_option('--network_version', type=str, default="img2img_v00.00_fcg2cityscapes.5.4")
...
def main(argv):
    ...
    global_config.a_path_train = old_network_config["dataset_a_train"]
    global_config.b_path_train = old_network_config["dataset_b_train"]
