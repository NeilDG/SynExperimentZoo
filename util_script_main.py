...
def main():
    # input_dir = "C:/Datasets/Segmentation Dataset/CityScapes/gtFine/*/*/*_color.png"  # Path to the input dataset
    # reference_dir = "C:/Datasets/Segmentation Dataset/CityScapes/leftImg8bit/*/*/"  # Reference size of the HR image
